...
<?php
    if(isset($_GET['del'])){
        ...
        $arr_del = mysqli_fetch_array($del_query);
        if($del_query) {
    ...
    <div class="container">
        <div class="cart_inner">
            <div class="table-responsive">
                ...
                <tbody>
                    <?php
                        $sel=mysqli_query($con, "SELECT * FROM product WHERE pro_cat='bread'");
                            ...
                            echo'
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="bread.php?del='.$arr['pro_id'].'" class="btn btn-danger btn-sm my-1" name="del"><i class="ti-trash"></i></a>
                                    </td>
                                </tr>';
                        };
                    ?>
