    ...
    <div class="container">
        <div class="cart_inner">
            <div class="table-responsive">
                ...
                <tbody>
                    <?php
                        $sel=mysqli_query($con, "SELECT * FROM product WHERE pro_cat='cold_drink'");
                            ...
                            echo'
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="cold_drink.php?del='.$arr['pro_id'].'" class="btn btn-danger btn-sm my-1" name="del"><i class="ti-trash"></i></a>
                                    </td>
                                </tr>';
                        };
                    ?>
